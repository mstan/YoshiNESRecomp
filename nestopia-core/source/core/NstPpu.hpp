...
namespace Nes
{
	namespace Core
	{
		...
		public: /* exposed for recomp bridge PPU comparison */
			Io io;
			Regs regs;
			Scroll scroll;
			Tiles tiles;
		...
		public:
			...
			/* Accessors for recomp bridge */
			const byte* GetOamRam() const { return oam.ram; }
			const byte* GetPaletteRam() const { return palette.ram; }
			const byte* GetNameTableRam() const { return nameTable.ram; }
