...
REPO_NAME="YoshiNESRecomp"      # GitHub repo / zip basename
APP_NAME="Yoshi"        # .app display name (may contain spaces)
TARGET="YoshiRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="nes"            # nes | snes | genesis | vb | psx
VERSION="v1.1.0-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Yoshi (USA) .nes dump"        # human description of the ROM the user must supply
# ==============================================
